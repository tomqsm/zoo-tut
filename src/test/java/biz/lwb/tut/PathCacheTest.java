...
import biz.lwb.tut.discovery.ExampleServer;
...
public class PathCacheTest extends BaseManualTest{
    private static final String PATH = "/example/cache";

    public static void main (String [] args ) throws Exception {
        BaseManualTest base = new PathCacheTest();
        PathChildrenCache cache = null;
        RetryPolicy retryPolicy = new ExponentialBackoffRetry(1000, 3);
        CuratorFramework client = base.newClient(retryPolicy);
        try {
            client.start();
